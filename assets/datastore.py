...
class Datastore:
    ...
    def update_game_attr(self, game, key, value):
    ...
    def add_item_to_room(self, room_id, item_name, item_pos):
        self.data['room'][room_id]['items'] = {
            item_name: {
                'last_pos': item_pos
            }
        }
    ...
    def add_interactive_to_room(self, room_id, interaction_name):
        self.data['room'][room_id]['interactions'] = {
            interaction_name: False
        }
        self.save_game()
    
    def update_room_attr(self, room_id, key, value):
        self.data['room'][room_id][key] = value
        self.save_game()

    def update_room_item(self, room_id, item, last_pos):
        self.data['room'][room_id]['items'][item] = {
            'last_pos': last_pos
        }
        self.save_game()
    
    def update_room_interactive(self, room_id, interactive, value):
        self.data['room'][room_id]['interactions'][interactive] = value
        self.save_game()

    def update_player_attr(self, key, value):
        self.data['player'][key] = value
        self.save_game()

    def update_inventory(self, action, item, room_id=None, quantity=None):
        if action == 'del':
    ...
    def get_room(self, room_id, type, key):
        if type == 'base':
    ...
    def get_inventory_item(self, key):
